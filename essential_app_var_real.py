# Versão modificada com cálculo real de VAR usando NAV
# Código gerado automaticamente com integração de análise real
...
class XMLRiskAnalyzer:
    ...
    def calculate_risk_metrics(self, nav_series: List[Dict[str, Any]], positions: List[Dict], fund_info: Dict) -> Dict[str, Any]:
        import numpy as np
        import pandas as pd
        if len(nav_series) < 2:
            raise ValueError("É necessário ao menos 2 dias de NAV para cálculo de volatilidade e VAR.")
        ...
        return {
            ...
            'var_1d_95pct': var_1d_95 * 100,
            'worst_observed': df["log_return"].min() * 100,
            'stress_scenarios': {
            ...
            'var_model_class': "Histórico com base em NAV",
        }
        risk_metrics = {}
