...
class XMLRiskAnalyzer:
    ...
    def calculate_var_from_navs(self, nav_series: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if len(nav_series) < 2:
            # Se não há dados suficientes, usar estimativa
        ...
        <div class="container">
            ...
            <div class="requirements">
                ...
                <ul>
                    ...
                    <li><strong>VaR Calculado:</strong> Baseado na série histórica real de NAVs</li>
                </ul>
                <div class="progress">
            ...
            <div style="margin: 20px 0;">
                ...
                {% if current_files >= min_files %}
                    <button onclick="window.location.href='/analyze'" class="btn btn-success">🚀 Executar Análise VaR Real</button>
                {% endif %}
            ...
            <ul>
                <li><strong>VAR Real</strong> - Calculado com série histórica de NAVs (21 dias úteis, 95% confiança)</li>
                <li>Volatilidade observada e retorno médio</li>
                <li>Classe de modelos para cálculo do VAR</li>
                <li>Cenários de estresse BM&FBOVESPA</li>
                <li>Pior retorno observado na série</li>
                <li>Análise de sensibilidade</li>
            </ul>
            
            <h2>🔗 API Endpoints</h2>
            <p><strong>GET /analyze</strong> - Executa análise VaR real e retorna JSON<br>
...
def upload_files():
    ...
    if current_xml_count >= MIN_XML_FILES:
        flash(f'🎉 {current_xml_count} arquivos carregados. VaR será calculado com dados reais!', 'success')
    else:
...
def health():
    ...
    return jsonify({
        ...
        'minimum_required': MIN_XML_FILES,
        'requirements_met': len(xml_files) >= MIN_XML_FILES,
        'var_calculation': 'Real NAV-based calculation' if len(xml_files) >= MIN_XML_FILES else 'Simulated'
    })
